import { ChoiceFieldFormatType, DateTimeFieldFormatType, DateTimeFieldFriendlyFormatType } from "@pnp/sp/fields";
...
export const setupLists = async (properties: ITasksWebPartProps) => {
    ...
    const taskLogsExists = await sp.web.lists.ensure(properties.taskLogsListTitle);
